...
## current run path
chr.dir.cur.run <- paste0(chr.dir.prime, args[2])
##chr.dir.cur.run <- paste0(chr.dir.prime,
##                               "/pest-hspf-files/cal-base")
...
## get observed flow
load(file = paste0(chr.dir.prime, "/ObsData/obs-flow.RData"))

## read hspf output
df.flow.mod.raw <- read.pltgen(paste0(chr.dir.cur.run, "/", 
                                 chr.file.model.in))
...
write.table(chr.mod.out, 
            file = paste0(chr.dir.cur.run,"/",chr.file.model.out), 
            row.names = FALSE, col.names = FALSE, quote = FALSE)

## write model.ins file
write.table(chr.mod.ins, 
            file = paste0(chr.dir.cur.run,"/",chr.file.model.ins), 
            row.names = FALSE, col.names = FALSE, quote = FALSE)
